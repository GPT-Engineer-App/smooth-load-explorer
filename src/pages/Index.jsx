    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              Dogs are domesticated mammals, part of the wolf family. They have been bred by humans for thousands of years for various purposes, including companionship, hunting, herding, and protection. Known for their loyalty and affection, dogs are often referred to as "man's best friend."
            </p>
          </CardContent>
        </Card>
